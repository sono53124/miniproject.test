...
// 서쪽 스타일적용
		...
		empty.setPreferredSize(new Dimension(340, 60));
...
//등록 메서드
	public void regist(int id) {
		...
		sql += "pg_end_day, pg_time, pg_price ,pg_total ,pg_file) values(sep_gym_program.nextval,?,?,?,?,?,?,?,?,?)";
...
//삭제 메서드
	...
	public boolean check() {
		boolean flag = false;
		if (t_Maxmember.getText().length() == 0) {
			JOptionPane.showMessageDialog(this, "최대 인원을 입력하세요");
			t_Maxmember.requestFocus();
			return flag;
